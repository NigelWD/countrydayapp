...
class ClubsViewController: UIViewController, WKNavigationDelegate, WKUIDelegate {
    ...
    override func viewDidLoad() {
        ...
        webView.load(URLRequest(url: URL(string: "https://jwelsh19.wixsite.com/website-2")!))
    ...
    @IBAction func home(_ sender: UIButton) {
        let myURL = URL(string: "https://jwelsh19.wixsite.com/website-2")
